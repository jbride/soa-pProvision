...
# JA Bride :  setting this variable appropriately for Apache Portable Runtime v2.0.9-linux2-x64-ssl
...
# JA Bride :  not needed with use of Apache Portable Runtime v2.0.9-linux2-x64-ssl
...
echo ""
echo "  JBOSS_NATIVE_DIR: $JBOSS_NATIVE_DIR"
echo ""
echo "========================================================================="
echo ""
